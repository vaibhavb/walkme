...
public partial class Redirect : Microsoft.Health.Web.HealthServiceActionPage
{
    ...
    //Implement going to the URL you came from, and not always landing on home page 
    protected override void OnActionApplicationAuthorizationSuccessful(string action, string actionQueryString)
    {
        string url = Server.UrlDecode(AntiXss.UrlEncode(Request.QueryString["actionqs"]));
        ...
        {
            Response.Redirect(Page.ResolveUrl("~/HVDefault.aspx"));
        }
    }
